...
conn = sqlite3.connect(r"C:\Users\Nikola\Desktop\web_dev\react\T-level mini-2\Python\UserName-PassWord.db",check_same_thread=False)

app = Flask(__name__)
CORS(app, resources={r"/*": {"origins": "*"}})

with open(r"C:\Users\Nikola\Desktop\web_dev\react\T-level mini-2\Python\OneJson.json","r") as file:
    j2 = json.load(file)
...
def signup():
    ...
    newPassword = data.get("finalPassword")
    conn = sqlite3.connect(r"C:\Users\Nikola\Desktop\web_dev\react\T-level mini-2\Python\UserName-PassWord.db",check_same_thread=False)
    cu = conn.cursor()
    validName = False 
    validPass = False
